...
-- Création d'un index sur chaque attribut d'une ligne de commande dans la table AchatProduit.
drop index I_Achat_commentaire;
create index I_Achat_commentaire on AchatProduit(commentaire);

drop index I_Achat_date;
create index I_Achat_date on AchatProduit(dateAchat);
